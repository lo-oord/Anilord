package anilord.app.suggestions.ui
...
import anilord.app.core.model.getLocale
...
import anilord.app.core.util.ext.asArrayList
import anilord.app.core.util.ext.awaitUniqueWorkInfoByName
import anilord.app.core.util.ext.awaitWorkInfosByTag
import anilord.app.core.util.ext.checkNotificationPermission
import anilord.app.core.util.ext.flatten
...
import anilord.app.core.util.ext.sanitize
import anilord.app.core.util.ext.takeMostFrequent
import anilord.app.core.util.ext.toBitmapOrNull
import anilord.app.core.util.ext.trySetForeground
...
import anilord.app.settings.work.PeriodicWorkScheduler
import anilord.app.suggestions.domain.MangaSuggestion
import anilord.app.suggestions.domain.SuggestionRepository
import anilord.app.suggestions.domain.TagsBlacklist
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "anilord.app.SUGGESTIONS"
