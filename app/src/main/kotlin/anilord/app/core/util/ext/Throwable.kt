...
import anilord.app.core.exceptions.BadBackupFormatException
import anilord.app.core.exceptions.CaughtException
import anilord.app.core.exceptions.CloudFlareBlockedException
import anilord.app.core.exceptions.CloudFlareException
import anilord.app.core.exceptions.CloudFlareProtectedException
import anilord.app.core.exceptions.EmptyHistoryException
import anilord.app.core.exceptions.EmptyMangaException
import anilord.app.core.exceptions.IncompatiblePluginException
import anilord.app.core.exceptions.InteractiveActionRequiredException
import anilord.app.core.exceptions.NoDataReceivedException
import anilord.app.core.exceptions.NonFileUriException
import anilord.app.core.exceptions.ProxyConfigException
import anilord.app.core.exceptions.UnsupportedFileException
import anilord.app.core.exceptions.UnsupportedSourceException
import anilord.app.core.exceptions.WrapperIOException
import anilord.app.core.exceptions.WrongPasswordException
...
import anilord.app.scrobbling.common.domain.ScrobblerAuthRequiredException
import java.io.File
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/anilord.app/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/anilord.app/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
