package anilord.app.core.network.webview
...
import anilord.app.browser.cloudflare.CloudFlareCallback
import anilord.app.browser.cloudflare.CloudFlareClient
import anilord.app.browser.cloudflare.CloudFlareInterceptClient
...
import anilord.app.core.util.ext.configureForParser
import anilord.app.core.util.ext.prepareDetachedParserViewport
import anilord.app.core.util.ext.printStackTraceDebug
import anilord.app.core.util.ext.sanitizeHeaderValue
...
class WebViewExecutor @Inject constructor(
	...
	/**
	 * Builds the very same WebViewClient that [anilord.app.browser.cloudflare.CloudFlareActivity] uses,
