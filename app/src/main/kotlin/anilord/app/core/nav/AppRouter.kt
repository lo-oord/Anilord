...
import anilord.app.alternatives.ui.AlternativesActivity
import anilord.app.backups.ui.backup.BackupDialogFragment
import anilord.app.backups.ui.restore.RestoreDialogFragment
import anilord.app.bookmarks.ui.AllBookmarksActivity
import anilord.app.browser.BrowserActivity
import anilord.app.browser.cloudflare.CloudFlareActivity
import anilord.app.core.exceptions.CloudFlareProtectedException
import anilord.app.core.image.CoilMemoryCacheKey
import anilord.app.core.model.FavouriteCategory
import anilord.app.core.model.MangaSourceInfo
import anilord.app.core.model.appUrl
import anilord.app.core.model.getTitle
import anilord.app.core.model.isAnime
import anilord.app.core.model.isBroken
...
import anilord.app.core.model.parcelable.ParcelableMangaPage
import anilord.app.core.network.CommonHeaders
...
import anilord.app.core.ui.dialog.ErrorDetailsDialog
import anilord.app.core.ui.dialog.buildAlertDialog
import anilord.app.core.util.ext.connectivityManager
import anilord.app.core.util.ext.findActivity
import anilord.app.core.util.ext.getThemeDrawable
import anilord.app.core.util.ext.printStackTraceDebug
import anilord.app.core.util.ext.toFileOrNull
import anilord.app.core.util.ext.toUriOrNull
import anilord.app.core.util.ext.withArgs
import anilord.app.details.ui.DetailsActivity
import anilord.app.details.ui.pager.ChaptersPagesSheet
import anilord.app.details.ui.related.RelatedMangaActivity
import anilord.app.details.ui.scrobbling.ScrobblingInfoSheet
import anilord.app.download.ui.dialog.DownloadDialogFragment
import anilord.app.download.ui.list.DownloadsActivity
import anilord.app.favourites.ui.FavouritesActivity
import anilord.app.favourites.ui.categories.FavouriteCategoriesActivity
import anilord.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import anilord.app.favourites.ui.categories.select.FavoriteDialog
import anilord.app.filter.ui.FilterCoordinator
import anilord.app.filter.ui.sheet.FilterSheetFragment
import anilord.app.filter.ui.tags.TagsCatalogSheet
import anilord.app.history.ui.HistoryActivity
import anilord.app.image.ui.ImageActivity
import anilord.app.list.ui.config.ListConfigBottomSheet
import anilord.app.list.ui.config.ListConfigSection
import anilord.app.local.ui.ImportDialogFragment
import anilord.app.local.ui.info.LocalInfoDialog
...
import anilord.app.reader.ui.colorfilter.ColorFilterConfigActivity
import anilord.app.reader.ui.config.ReaderConfigSheet
import anilord.app.reader.ui.novel.NovelReaderConfigSheet
...
import anilord.app.settings.override.OverrideConfigActivity
import anilord.app.settings.reader.ReaderTapGridConfigActivity
import anilord.app.settings.sources.auth.CredentialsSourceAuthActivity
import anilord.app.settings.sources.auth.SourceAuthActivity
import anilord.app.settings.sources.catalog.SourcesCatalogActivity
import anilord.app.settings.storage.MangaDirectorySelectDialog
import anilord.app.settings.storage.directories.MangaDirectoriesActivity
import anilord.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import anilord.app.stats.ui.StatsActivity
import anilord.app.stats.ui.sheet.MangaStatsSheet
import anilord.app.suggestions.ui.SuggestionsActivity
import anilord.app.tracker.ui.updates.UpdatesActivity
import java.io.File
...
class AppRouter private constructor(
    ...
    fun openPlayStore(chooserTitle: CharSequence? = null): Boolean {
        val marketIntent = Intent(Intent.ACTION_VIEW, "market://details?id=anilord.app".toUri())
