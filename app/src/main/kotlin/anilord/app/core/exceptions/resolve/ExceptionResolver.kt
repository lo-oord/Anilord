package anilord.app.core.exceptions.resolve
...
import anilord.app.core.util.ext.findCloudFlareException
import anilord.app.core.util.ext.isHttpUrl
import anilord.app.core.util.ext.restartApplication
...
import anilord.app.scrobbling.common.ui.ScrobblerAuthHelper
...
class ExceptionResolver private constructor(
    ...
    suspend fun resolve(e: Throwable): Boolean = host.lifecycleScope.async {
		val cloudFlareError = e.findCloudFlareException()
		if (cloudFlareError is CloudFlareProtectedException) {
			return@async resolveCF(cloudFlareError)
		}
        when (e) {
