...
import anilord.app.core.parser.CachingMangaRepository
import anilord.app.core.parser.MangaRepository
import anilord.app.core.prefs.AppSettings
import anilord.app.core.ui.image.TrimTransformation
import anilord.app.core.util.FileSize
import anilord.app.core.util.MimeTypes
import anilord.app.core.util.ext.URI_SCHEME_ZIP
import anilord.app.core.util.ext.cancelChildrenAndJoin
import anilord.app.core.util.ext.compressToPNG
import anilord.app.core.util.ext.ensureRamAtLeast
import anilord.app.core.util.ext.ensureSuccess
import anilord.app.core.util.ext.getCompletionResultOrNull
import anilord.app.core.util.ext.isFileUri
import anilord.app.core.util.ext.isNotEmpty
import anilord.app.core.util.ext.isPowerSaveMode
import anilord.app.core.util.ext.isZipUri
import anilord.app.core.util.ext.lifecycleScope
import anilord.app.core.util.ext.mangaSourceExtra
import anilord.app.core.util.ext.printStackTraceDebug
import anilord.app.core.util.ext.ramAvailable
import anilord.app.core.util.ext.toMimeType
import anilord.app.core.util.ext.use
import anilord.app.core.util.ext.withProgress
import anilord.app.core.util.progress.ProgressDeferred
import anilord.app.download.ui.worker.DownloadSlowdownDispatcher
