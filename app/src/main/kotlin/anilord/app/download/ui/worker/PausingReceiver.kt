...
import anilord.app.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "anilord.app.download.PAUSE"
		private const val ACTION_RESUME = "anilord.app.download.RESUME"
		private const val ACTION_SKIP = "anilord.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "anilord.app.download.SKIP_ALL"
