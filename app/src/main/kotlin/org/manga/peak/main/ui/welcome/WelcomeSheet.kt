...
import org.manga.peak.databinding.SheetWelcomeBinding
...
class WelcomeSheet : BaseAdaptiveSheet<SheetWelcomeBinding>(), ChipsView.OnChipClickListener, View.OnClickListener,
	...
	override fun onChipClick(chip: Chip, data: Any?) {
		when (data) {
			is SourceContentType -> viewModel.setTypeChecked(data, !chip.isChecked)
	...
	private fun onTypesChanged(value: FilterProperty<SourceContentType>) {
