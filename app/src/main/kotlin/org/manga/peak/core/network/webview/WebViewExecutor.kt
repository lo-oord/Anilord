package org.manga.peak.core.network.webview
...
import org.manga.peak.browser.cloudflare.CloudFlareCallback
import org.manga.peak.browser.cloudflare.CloudFlareClient
import org.manga.peak.browser.cloudflare.CloudFlareInterceptClient
...
import org.manga.peak.core.util.ext.prepareDetachedParserViewport
import org.manga.peak.core.util.ext.printStackTraceDebug
import org.manga.peak.core.util.ext.sanitizeHeaderValue
...
class WebViewExecutor @Inject constructor(
	...
	/**
	 * Builds the very same WebViewClient that [org.manga.peak.browser.cloudflare.CloudFlareActivity] uses,
