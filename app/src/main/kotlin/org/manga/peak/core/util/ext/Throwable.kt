...
import org.manga.peak.core.exceptions.BadBackupFormatException
import org.manga.peak.core.exceptions.CaughtException
import org.manga.peak.core.exceptions.CloudFlareBlockedException
import org.manga.peak.core.exceptions.CloudFlareException
import org.manga.peak.core.exceptions.CloudFlareProtectedException
import org.manga.peak.core.exceptions.EmptyHistoryException
import org.manga.peak.core.exceptions.EmptyMangaException
import org.manga.peak.core.exceptions.IncompatiblePluginException
import org.manga.peak.core.exceptions.InteractiveActionRequiredException
import org.manga.peak.core.exceptions.NoDataReceivedException
import org.manga.peak.core.exceptions.NonFileUriException
import org.manga.peak.core.exceptions.ProxyConfigException
import org.manga.peak.core.exceptions.UnsupportedFileException
import org.manga.peak.core.exceptions.UnsupportedSourceException
import org.manga.peak.core.exceptions.WrapperIOException
import org.manga.peak.core.exceptions.WrongPasswordException
...
import org.manga.peak.scrobbling.common.domain.ScrobblerAuthRequiredException
import java.io.File
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/org.manga.peak/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/org.manga.peak/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
