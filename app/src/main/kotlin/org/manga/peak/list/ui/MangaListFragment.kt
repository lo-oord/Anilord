...
import org.manga.peak.alternatives.ui.AutoFixService
...
import org.manga.peak.core.ui.list.FitHeightGridLayoutManager
import org.manga.peak.core.ui.list.FitHeightLinearLayoutManager
import org.manga.peak.core.ui.list.ListSelectionController
import org.manga.peak.core.ui.list.PaginationScrollListener
...
import org.manga.peak.core.util.ext.viewLifecycleScope
...
abstract class MangaListFragment :
	...
	override fun onPrepareActionMode(controller: ListSelectionController, mode: ActionMode?, menu: Menu): Boolean {
		...
		val hasDownloadableItems = selectedItems.isNotEmpty()
		val isSingleSelection = controller.count == 1
		menu.findItem(R.id.action_save)?.isVisible = hasNoLocal && hasDownloadableItems
