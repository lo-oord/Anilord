package org.manga.peak.favourites.data
...
import org.manga.peak.core.db.MangaQueryBuilder
import org.manga.peak.core.db.TABLE_FAVOURITES
import org.manga.peak.core.db.entity.MangaWithTags
...
import org.manga.peak.list.domain.ReadingProgress.Companion.PROGRESS_COMPLETED
