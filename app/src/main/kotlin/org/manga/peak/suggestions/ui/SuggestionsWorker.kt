...
import org.manga.peak.core.model.distinctById
import org.manga.peak.core.model.getLocale
...
import org.manga.peak.core.util.ext.asArrayList
import org.manga.peak.core.util.ext.awaitUniqueWorkInfoByName
import org.manga.peak.core.util.ext.awaitWorkInfosByTag
import org.manga.peak.core.util.ext.checkNotificationPermission
import org.manga.peak.core.util.ext.flatten
...
import org.manga.peak.core.util.ext.sanitize
import org.manga.peak.core.util.ext.takeMostFrequent
import org.manga.peak.core.util.ext.toBitmapOrNull
import org.manga.peak.core.util.ext.trySetForeground
...
import org.manga.peak.settings.work.PeriodicWorkScheduler
import org.manga.peak.suggestions.domain.MangaSuggestion
import org.manga.peak.suggestions.domain.SuggestionRepository
import org.manga.peak.suggestions.domain.TagsBlacklist
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "org.manga.peak.SUGGESTIONS"
