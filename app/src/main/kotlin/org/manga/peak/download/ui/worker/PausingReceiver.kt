...
import org.manga.peak.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "org.manga.peak.download.PAUSE"
		private const val ACTION_RESUME = "org.manga.peak.download.RESUME"
		private const val ACTION_SKIP = "org.manga.peak.download.SKIP"
		private const val ACTION_SKIP_ALL = "org.manga.peak.download.SKIP_ALL"
