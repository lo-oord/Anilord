...
import org.manga.peak.databinding.ItemDownloadBinding
import org.manga.peak.download.ui.list.chapters.DownloadChapter
import org.manga.peak.download.ui.list.chapters.downloadChapterAD
	...
	bind { payloads ->
		...
		when (item.workState) {
			...
			WorkInfo.State.RUNNING -> {
				...
				// An indeterminate transfer has no known total. Showing "0%" beside an
				// animated bar makes an active HLS/chunked download look frozen.
				binding.textViewPercent.isVisible = !item.isIndeterminate
