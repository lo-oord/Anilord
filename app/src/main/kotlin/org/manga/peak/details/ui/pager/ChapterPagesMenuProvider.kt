...
import org.manga.peak.core.util.progress.IntPercentLabelFormatter
import org.manga.peak.details.ui.pager.ChaptersPagesSheet.Companion.TAB_BOOKMARKS
import org.manga.peak.details.ui.pager.ChaptersPagesSheet.Companion.TAB_CHAPTERS
import org.manga.peak.details.ui.pager.ChaptersPagesSheet.Companion.TAB_PAGES
	...
	override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
		...
		when (tab) {
			TAB_CHAPTERS -> {
				...
				menu.findItem(R.id.action_grid_view)?.let { menuItem ->
					menuItem.isVisible = !viewModel.isNovelContent
					menuItem.isChecked = viewModel.isChaptersInGridView.value == true
				}
