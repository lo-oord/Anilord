...
import org.manga.peak.core.ui.sheet.AdaptiveSheetBehavior.Companion.STATE_COLLAPSED
import org.manga.peak.core.ui.sheet.AdaptiveSheetBehavior.Companion.STATE_DRAGGING
import org.manga.peak.core.ui.sheet.AdaptiveSheetBehavior.Companion.STATE_EXPANDED
import org.manga.peak.core.ui.sheet.AdaptiveSheetBehavior.Companion.STATE_SETTLING
import org.manga.peak.core.ui.sheet.AdaptiveSheetCallback
import org.manga.peak.core.ui.sheet.BaseAdaptiveSheet
import org.manga.peak.core.ui.util.ActionModeListener
import org.manga.peak.core.ui.util.MenuInvalidator
import org.manga.peak.core.ui.util.RecyclerViewOwner
import org.manga.peak.core.ui.util.ReversibleActionObserver
import org.manga.peak.core.util.ext.doOnPageChanged
import org.manga.peak.core.util.ext.findCurrentPagerFragment
import org.manga.peak.core.util.ext.menuView
import org.manga.peak.core.util.ext.observe
import org.manga.peak.core.util.ext.observeEvent
import org.manga.peak.core.util.ext.recyclerView
import org.manga.peak.core.util.ext.smoothScrollToTop
import org.manga.peak.databinding.SheetChaptersPagesBinding
import org.manga.peak.details.ui.DetailsViewModel
import org.manga.peak.details.ui.ReadButtonDelegate
