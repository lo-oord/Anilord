...
import org.manga.peak.core.model.titleResId
...
import org.manga.peak.core.parser.favicon.faviconUri
...
import org.manga.peak.core.ui.image.TextDrawable
import org.manga.peak.core.ui.image.TextViewTarget
import org.manga.peak.core.ui.list.OnListItemClickListener
import org.manga.peak.core.ui.sheet.BottomSheetCollapseCallback
import org.manga.peak.core.ui.util.MenuInvalidator
import org.manga.peak.core.ui.util.ReversibleActionObserver
import org.manga.peak.core.ui.widgets.ChipsView
import org.manga.peak.core.util.FileSize
import org.manga.peak.core.util.LocaleUtils
...
import org.manga.peak.core.util.ext.end
import org.manga.peak.core.util.ext.enqueueWith
import org.manga.peak.core.util.ext.getThemeColor
import org.manga.peak.core.util.ext.getQuantityStringSafe
import org.manga.peak.core.util.ext.isAnimationsEnabled
import org.manga.peak.core.util.ext.isTextTruncated
import org.manga.peak.core.util.ext.joinToStringWithLimit
...
import org.manga.peak.core.util.ext.parentView
import org.manga.peak.core.util.ext.setTooltipCompat
import org.manga.peak.core.util.ext.start
import org.manga.peak.core.util.ext.textAndVisible
import org.manga.peak.core.util.ext.toUriOrNull
import org.manga.peak.databinding.ActivityDetailsBinding
import org.manga.peak.databinding.LayoutDetailsTableBinding
import org.manga.peak.details.data.MangaDetails
import org.manga.peak.details.data.ReadingTime
import org.manga.peak.details.service.MangaPrefetchService
import org.manga.peak.details.ui.model.ChapterListItem
import org.manga.peak.details.ui.model.HistoryInfo
import org.manga.peak.details.ui.scrobbling.ScrobblingItemDecoration
import org.manga.peak.details.ui.scrobbling.ScrollingInfoAdapter
import org.manga.peak.download.ui.worker.DownloadStartedObserver
...
import org.manga.peak.list.ui.size.StaticItemSizeResolver
