package org.manga.peak.local.data.output
...
import org.manga.peak.core.zip.ZipOutput
...
class LocalMangaDirOutput(
	...
	suspend fun deleteChapters(ids: Set<Long>) = mutex.withLock {
		...
		for (chapter in chapters) {
			...
			val chapterFile = index.getChapterFileName(chapter.value.id)?.let { relativePath ->
				File(rootFile, relativePath.substringBefore('/'))
