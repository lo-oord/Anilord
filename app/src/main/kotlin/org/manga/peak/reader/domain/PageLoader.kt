...
import org.manga.peak.core.parser.CachingMangaRepository
import org.manga.peak.core.parser.MangaRepository
import org.manga.peak.core.prefs.AppSettings
import org.manga.peak.core.ui.image.TrimTransformation
import org.manga.peak.core.util.FileSize
import org.manga.peak.core.util.MimeTypes
import org.manga.peak.core.util.ext.URI_SCHEME_ZIP
import org.manga.peak.core.util.ext.cancelChildrenAndJoin
import org.manga.peak.core.util.ext.compressToPNG
import org.manga.peak.core.util.ext.ensureRamAtLeast
import org.manga.peak.core.util.ext.ensureSuccess
import org.manga.peak.core.util.ext.getCompletionResultOrNull
import org.manga.peak.core.util.ext.isFileUri
import org.manga.peak.core.util.ext.isNotEmpty
import org.manga.peak.core.util.ext.isPowerSaveMode
import org.manga.peak.core.util.ext.isZipUri
import org.manga.peak.core.util.ext.lifecycleScope
import org.manga.peak.core.util.ext.mangaSourceExtra
import org.manga.peak.core.util.ext.printStackTraceDebug
import org.manga.peak.core.util.ext.ramAvailable
import org.manga.peak.core.util.ext.toMimeType
import org.manga.peak.core.util.ext.use
import org.manga.peak.core.util.ext.withProgress
import org.manga.peak.core.util.progress.ProgressDeferred
import org.manga.peak.download.ui.worker.DownloadSlowdownDispatcher
...
class PageLoader @Inject constructor(
	...
	private suspend fun loadPageAttempt(
		...
		if (proChanPageStitcher.isStitchUrl(pageUrl)) {
			return proChanPageStitcher.load(
				mapUrl = pageUrl,
				source = page.source,
				skipCache = skipCache,
