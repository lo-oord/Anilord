...
import org.manga.peak.core.util.ext.findKeyByValue
import org.manga.peak.reader.ui.pager.BaseReaderFragment
import org.manga.peak.reader.ui.pager.doublepage.DoubleReaderFragment
import org.manga.peak.reader.ui.pager.doublereversed.ReversedDoubleReaderFragment
import org.manga.peak.reader.ui.pager.reversed.ReversedReaderFragment
import org.manga.peak.reader.ui.pager.standard.PagerReaderFragment
import org.manga.peak.reader.ui.pager.vertical.VerticalReaderFragment
import org.manga.peak.reader.ui.pager.webtoon.WebtoonReaderFragment
import org.manga.peak.reader.ui.novel.NovelReaderFragment
