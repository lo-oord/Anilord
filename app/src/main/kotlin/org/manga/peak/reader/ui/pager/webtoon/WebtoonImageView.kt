...
import org.manga.peak.core.util.ext.resolveDp
...
class WebtoonImageView @JvmOverloads constructor(
	...
	override fun recycle() {
		scrollPos = 0
		// Decoder shutdown may race a late tile callback when RecyclerView rapidly reuses
		// a webtoon page. SSIV has no useful recovery to expose to the UI at this point,
		// so keep the recycled holder alive and let the next bind install a fresh image.
		try {
			super.recycle()
