...
class ParserProcessor(
    ...
    private fun writeContent(
		...
		val totalCount = symbols
			// A newly added parser can reference the MangaParserSource entry that
			// this processor is about to generate. KSP marks that declaration as
			// unresolved during the first round, so filtering by validate() drops
			// the new source permanently and the generated enum never gets it.
